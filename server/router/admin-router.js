...
const { userr, ser, con,deleteUserById,getUserById,updateUserById,deleteContactById,deleteServiceById,addService} = require("../controller/admin-controller");
...
router
  .route("/services/add")
  .post(authMiddleware, adminMiddleware, addService);
